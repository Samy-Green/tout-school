import PageContainer from '#components/mui/page_container'
import {
  deleteOne as deleteEmployee,
  getOne as getEmployee,
  type Employee,
} from '#inertia/data/employees'
import { useNavigate, useParams } from '#inertia/hooks/fakeRooter/index'
import { useDialogs } from '#inertia/hooks/useDialogs/use_dialogs'
...
export default function EmployeeShow() {
  ...
  return (
    <PageContainer
      title={pageTitle}
      breadcrumbs={[{ title: 'Employees', path: '/employees' }, { title: pageTitle }]}
    >
